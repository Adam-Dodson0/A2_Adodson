...
/**
 * An imutable record of a single completed maintenance event on a Maintainable
 * attraction. Every field is private and final, and there are no setters, so
 * once created a record can never be altered - a permanent log entry just like
 * a physical maintenance logbook
 */
public final class MaintenanceRecord {
    ...
    /**
     * Creates a new maintenance record, that is timestamped at the moment of
     * creation
     *
     ...
     * @param downtimeMinutes how long the maintainable item was out of service,
     * displayed in minutes.
     *
     * @throws NullPointerException if Type, notes or technician is null.
     * @throws IllegalArgumentException if notes is blank or downtimeMinutes is
     * negative
     */
